...
public class RegistrarUsuarioStepDefinition {
    ...
    public void seRealizaElRegistroDeManeraExitosa() {
        ...
        try {
            ...
            theActorInTheSpotlight().should(GivenWhenThen.seeThat("El mensaje de registro correcto", RegisterQuestion.visibleEn(AccountPage.LBL_MY_ACCOUNT), equalTo("My Account")));
            Thread.sleep(5000);
